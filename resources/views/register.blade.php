                    ...
                    <form method="POST" action="{{ route('register.store') }}" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control form-control-lg border-start-0 @error('telefone') is-invalid @enderror" id="telefone" name="telefone" value="{{ old('telefone') }}" required placeholder="Ex.: (11) 98765-4321">
                            </div>
                            @error('telefone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            <label for="data_nascimento" class="form-label fw-medium text-muted">Data de Nascimento</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="fas fa-calendar text-primary"></i></span>
                                <input type="date" class="form-control form-control-lg border-start-0 @error('data_nascimento') is-invalid @enderror" id="data_nascimento" name="data_nascimento" value="{{ old('data_nascimento') }}" required>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-lg @error('sexo') is-invalid @enderror" id="sexo" name="sexo" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-lg @error('disability_type') is-invalid @enderror" id="disability_type" name="disability_type" required>
                                <option value="" disabled selected>Selecione uma opção</option>
                                ...
                                <option value="fisica" {{ old('disability_type') == 'fisica' ? 'selected' : '' }}>Física</option>
                                <option value="intelectual" {{ old('disability_type') == 'intelectual' ? 'selected' : '' }}>Intelectual</option>
                                <option value="nenhuma" {{ old('disability_type') == 'nenhuma' ? 'selected' : '' }}>Outros</option>
                            </select>
